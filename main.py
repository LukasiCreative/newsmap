...
components.html(
    ...
    <body>
        ...
        <script>
             ...
             * ONLY CHANGE:
             *
             * Headline remains visible for 10 seconds.
             * ====================================================
             */
...
# ================================================================
# RED PINS DETERMINE INITIAL MAP VIEW
# ================================================================
...
# If there are no red pins, fall back to all available pins.
...
if focus_pin_items:
    ...
    if len(focus_pin_items) == 1:
        ...
        # SMALL PADDING
        #
        # This is intentionally much tighter than before.
        # --------------------------------------------------------
